...
class Internal_Game_State:
    ...
    player_move_power: int = field(default_factory=int)
    ...
    def __init__(self, game=None):
       ...
       # Events
        ...
        self.player_move_power = ram_map.player_move_power(game)
        self.player_move_type_in_battle = ram_map.player_move_type_in_battle(game)
    ...
    def validation(self):
        ...
        if   self.enemy_current_move_effect is not None and self.enemy_current_move_effect > 166:
        ...
        if self.player_selected_move_effect > 165:
